function generate() {
    ...
    //number of circles we're making
    ...
    for(c1tick = 1; c1tick < c1_maxbokeh; c1tick ++) {
        ...
        drawBokeh(posx, posy);//needs to be real function kthx
    }
    //populate cycle 2
...
//I don't always fuzzy and purple, but when I do it's because of this function
